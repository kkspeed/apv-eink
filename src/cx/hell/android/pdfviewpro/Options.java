...
public class Options extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	public final static String PREF_LEFT_TAP_PAIR = "leftTapPair";
	public final static String PREF_RIGHT_TAP_PAIR = "rightTapPair";
	...
	private static final String[] summaryKeys = { PREF_ZOOM_ANIMATION, PREF_ORIENTATION, PREF_PAGE_ANIMATION,
		...
		PREF_LONG_ZOOM_PAIR, PREF_UP_DOWN_PAIR, PREF_LEFT_TAP_PAIR, PREF_RIGHT_TAP_PAIR, PREF_RIGHT_UP_DOWN_PAIR,
		PREF_TOP_BOTTOM_TAP_PAIR };
	private static final int[] summaryEntryValues = { 
		R.array.zoom_animations,    R.array.orientations, R.array.page_animations,
		R.array.fade_speeds,        R.array.color_modes,  R.array.boxes, 
		R.array.margins,            R.array.margins,      R.array.extra_caches, 
		R.array.double_tap_actions, R.array.action_pairs, R.array.action_pairs,
		R.array.action_pairs,       R.array.action_pairs, R.array.action_pairs, 
		R.array.action_pairs,       R.array.action_pairs, R.array.action_pairs  };

	private static final int[] summaryEntries = { 
		R.array.zoom_animation_labels,    R.array.orientation_labels, R.array.page_animation_labels,
		R.array.fade_speed_labels,        R.array.color_mode_labels,  R.array.box_labels, 
		R.array.margin_labels,            R.array.margin_labels,      R.array.extra_cache_labels, 
		R.array.double_tap_action_labels, R.array.action_pair_labels, R.array.action_pair_labels,
		R.array.action_pair_labels,       R.array.action_pair_labels, R.array.action_pair_labels,
		R.array.action_pair_labels,       R.array.action_pair_labels, R.array.action_pair_labels };

	private static final int[] summaryDefaults = { 
		R.string.default_zoom_animation,   R.string.default_orientation,        R.string.default_page_animation,
		R.string.default_fade_speed,       R.string.default_color_mode,         R.string.default_box, 
		R.string.default_side_margin,      R.string.default_top_margin,         R.string.default_extra_cache, 
		R.string.default_double_tap_action,R.string.default_volume_pair,        R.string.default_zoom_pair,
		R.string.default_long_zoom_pair,   R.string.default_up_down_pair,       R.string.default_left_tap_pair, 
		R.string.default_right_tap_pair,   R.string.default_right_up_down_pair, R.string.default_top_bottom_tap_pair };
